...
var users_1 = require("../../repositories/DELETE/users");
var DeleteUserController = /** @class */ (function () {
    function DeleteUserController() {
    }
    DeleteUserController.prototype.remove = function (httpRequest) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        id = _b.sent();
                        return [4 /*yield*/, new users_1.DeleteUserRepository().delete(id)];
                    case 3:
                        _b.sent();
                        return [2 /*return*/, (0, helpers_1.successfull)('User deleted successfully')];
                    case 4: return [3 /*break*/, 6];
                    case 5:
                        error_1 = _b.sent();
                        return [2 /*return*/, (0, helpers_1.internalError)('DELETE USER FAILED INTERNAL ERROR')];
