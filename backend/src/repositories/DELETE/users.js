...
var DeleteUserRepository = /** @class */ (function () {
    function DeleteUserRepository() {
    }
    DeleteUserRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, postgre_1.PostgreClient.db.query("\n      DELETE FROM users WHERE id = '".concat(id, "'\n    "))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
