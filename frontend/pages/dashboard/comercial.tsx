...
function Comercial() {
  ...
  const [panelState, setPanelstate] = useState<'sales' | 'products'>('products')
    ...
    <body className="w-full h-full min-h-screen bg-gray-100 flex flex-row flex-nowrap">
      ...
      <main className="w-full h-full min-h-screen">
        ...
        <section className="w-full h-full flex flex-col justify-start items-start p-6 gap-5 max-[500px]:p-3">
          ...
          <article className="bg-white p-4 rounded-lg w-full h-full flex flex-row justify-between items-center gap-2 flex-nowrap max-[500px]:p-2">
